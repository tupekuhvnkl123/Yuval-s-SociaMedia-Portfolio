      ...
      <div className={classes.infoContainer}>
        ...
        <div className={classes.textContainer}>
          <p className={classes.text}>
            ...
            meaningful ways. <br />
            <br />
            My passion lies in crafting compelling narratives, engaging content,
            and strategic campaigns that drive results. Clients should choose me
            because I bring a creative yet data-driven approach, staying updated
            with the latest trends and algorithms to ensure maximum impact.{" "}
            <br />
            <br />
